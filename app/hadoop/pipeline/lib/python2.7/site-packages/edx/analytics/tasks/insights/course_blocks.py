...
import sys
sys.path.insert(0,'/edx/app/hadoop/pipeline/local/lib/python2.7/site-packages/edx/analytics/tasks/')
...
from insights.course_list import CourseListApiDataTask, CourseRecord, TimestampPartitionMixin
...
from util.record import BooleanField, IntegerField, Record, StringField
