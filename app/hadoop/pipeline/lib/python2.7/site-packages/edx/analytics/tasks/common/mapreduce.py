...
import imp
#manifest = imp.load_source('manifest','/edx/app/hadoop/pipeline/local/lib/python2.7/site-packages/edx/analytics/tasks/util/manifest.py')
#url = imp.load_source('url','/edx/app/hadoop/pipeline/local/lib/python2.7/site-packages/edx/analytics/tasks/util/url.py')
#from edx.analytics.tasks.util.manifest import convert_to_manifest_input_if_necessary, remove_manifest_target_if_exists
from util.manifest import convert_to_manifest_input_if_necessary, remove_manifest_target_if_exists
