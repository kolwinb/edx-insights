...
//
// Debug information:
// Generated date: Thu Jun 06 10:29:16 IST 2019
...
public class courseware_studentmodule extends SqoopRecord  implements DBWritable, Writable {
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.course_id = JdbcWritableBridge.readString(4, __dbResults);
    ...
    this.done = JdbcWritableBridge.readString(8, __dbResults);
    this.created = JdbcWritableBridge.readTimestamp(9, __dbResults);
    this.modified = JdbcWritableBridge.readTimestamp(10, __dbResults);
    this.student_id = JdbcWritableBridge.readInteger(11, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(course_id, 4 + __off, 12, __dbStmt);
    ...
    JdbcWritableBridge.writeString(done, 8 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeTimestamp(created, 9 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(modified, 10 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeInteger(student_id, 11 + __off, 4, __dbStmt);
    return 11;
  }
...
this.readFields0(__dataIn);  }
  ...
  public void clone0(courseware_studentmodule o) throws CloneNotSupportedException {
    o.created = (o.created != null) ? (java.sql.Timestamp) o.created.clone() : null;
    o.modified = (o.modified != null) ? (java.sql.Timestamp) o.modified.clone() : null;
  }
