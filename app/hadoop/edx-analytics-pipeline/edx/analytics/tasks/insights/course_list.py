...
import sys
#sys.path.insert(0,'/edx/app/hadoop/pipeline/local/lib/python2.7/site-packages')

#sys.path.append('/edx/app/hadoop/pipeline/local/lib/python2.7/site-packages')
sys.path.append('/edx/app/hadoop/pipeline/local/lib/python2.7/site-packages/edx/analytics/tasks')
#sys.path.append('/edx/app/hadoop/pipeline/local/lib/python2.7/site-packages/edx/analytics/tasks/common')
#sys.path.append('/edx/app/hadoop/pipeline/local/lib/python2.7/site-packages/edx/analytics')


import imp
#mapreduce = imp.load_source('mapreduce','/edx/app/hadoop/pipeline/local/lib/python2.7/site-packages/edx/analytics/tasks/common/mapreduce.py')
from edx.analytics.tasks.common.mapreduce import MapReduceJobTask, MapReduceJobTaskMixin
#from mapreduce import MapReduceJobTask, MapReduceJobTaskMixin
#from common.mapreduce import MapReduceJobTask, MapReduceJobTaskMixin
...
log.error("current working path : %s",os.getcwd())
